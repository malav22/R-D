...
<body>
  ...
  <div class="main-container">
    ...
    <p>
      The newly joined faculty should apply for such grant within the first one year of service in the Institute and who do not have R&D Projects from External Funding Agencies. In return, the Institute has certain expectations from the new faculty members. These are: </p>
    <ul>
      <li>
        At least one grant proposal submitted within the first 6-8 months after joining, and independent research funding secured within about a year.
      </li>
      <li>
    ...
    <div style="text-align:left;">
      ...
      <ol>
        ...
        <li>
          All the PIs of FRS projects should avail the same financial powers as approved by competent authority of IIT(ISM) to PIs of external projects of different sponsoring agencies.

        </li>
        <li>
          The indents costing more than the sanctioning power of the PIs should be raised duly observing IIT(ISM) Purchase Manual procedures and to be submitted to Dean(R&D) for approval/endorsement alongwith a copy of the budget provision. However, if indented items which are within the sanctioning power of concerned PIs, the same may be dealt at the departmental level. Such indents need not be sent to Dean(R&D) for his approval.

        </li>
        <li>
          All the PIs should submit Half-yearly progress reports (April – Sept, October – March) alongwith the Expenditure Statement through their respective HODs, to Dean(R&D). A presentation of progress every year be made by P.I. to the Department and report be sent to Dean(R&D).

        </li>
        <li>
          The equipment/instruments which will be procured under these projects should be made accessible to other users, within and outside the Department. Necessary mechanism for extending the facilities at IIT(ISM) will be intimated which is under preparation.
        ...
        <li>
          Acknowledgement to IIT(ISM) is essential in case of publication/patent.
        ...
        <li>
          On completion of the project following are to be submitted to the office of the undersigned:
          <ul>
            <li>
