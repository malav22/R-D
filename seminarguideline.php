...
<body>
  ...
  <div class="main-container">
    <h1>General Guidelines for Organizing Joint Seminar/Symposium/Conference etc</h1>
    <p>
    ...
    <ul>
      ...
      <li>
        A preliminary/tentative budget estimate should also be submitted along with the proposal.
      </li>
    </ul>
    </p>
    <p>
    ...
    <p>
      15% of the Total revenue generated
    </p>
