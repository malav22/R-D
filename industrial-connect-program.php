  ...
  <div class="main-container">
    ...
    <p>
      <b style="color:#A52A2A;">
        Participation under CSR can be in following modes :
      </b>
    </p>
    <ul>
      <li>
        Research Projects of Mutual Benefits

      </li>
      <li>
        Developments of laboratories
      ...
      <li>
        Encourage your employee to participate in the research

      </li>
      <li>
        Donation for academic buildings/classrooms/ hostel

      </li>
    </ul>
    <p>
      <b style="color:#A52A2A;">
        This activity may result in several in-direct advantages viz.,
      </b>
    </p>
    <ul>
      <li>
        Built a relationship with faculty/students

      </li>
      <li>
        Tap into innovative ideas by students, attract good students as employees

      </li>
      <li>
        Open new areas for future research and development

      </li>
      <li>
        Explore the state-of-the-art laboratories and equipment

      </li>
      <li>
        Get the right media attention

      </li>
    </ul>
    <p>
      <b style="color:#A52A2A;">
      Tax Benefits: Exemption under Section 35(1)(ii)(iii)
      </b>
    </p>
    <p>
